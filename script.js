...
window.addEventListener('click', (ev) => {
  ...
  const ravenColorData = detectPixelColor.data;
  ravens.forEach((raven) => {
    if (
      raven.randomColors[0] === ravenColorData[0] &&
      raven.randomColors[1] === ravenColorData[1] &&
      raven.randomColors[2] === ravenColorData[2]
    ) {
      //collision detected
