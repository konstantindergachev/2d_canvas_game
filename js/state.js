...
export class SittingLeft extends State {
  ...
  enter() {
    this.player.frameY = 9; //row in the sprite sheet
    this.player.speed = 0;
  }
  handleInput(input) {
...
export class SittingRight extends State {
  ...
  enter() {
    this.player.frameY = 8; //row in the sprite sheet
    this.player.speed = 0;
  }
  handleInput(input) {
...
export class JumpingLeft extends State {
  ...
  handleInput(input) {
    ...
    else if (this.player.velocityY > 0) this.player.setState(states.FALLING_LEFT);
  }
}
...
export class JumpingRight extends State {
  ...
  handleInput(input) {
    ...
    else if (this.player.velocityY > 0) this.player.setState(states.FALLING_RIGHT);
  }
}
